...
CREATE TABLE rooms (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  author_id BIGINT NOT NULL REFERENCES profiles on delete set null,
  name TEXT NOT NULL,
...
CREATE TABLE controls (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  room_id BIGINT NOT NULL UNIQUE REFERENCES rooms on delete cascade,
  speaker_id BIGINT UNIQUE REFERENCES profiles on delete set null,
  change_by BIGINT UNIQUE REFERENCES profiles on delete set null,
...
CREATE TABLE messages (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  profile_id BIGINT NOT NULL REFERENCES profiles on set null,
